...
export function CADOverlay({ loading = false, targetRef }: { loading?: boolean, targetRef?: React.RefObject<HTMLDivElement | null> }) {
  ...
  if (windowWidth < 640) {
    ...
    TREE_ROTATION_DEG = 15;
    TREE_TRANSLATE_X = 100;
    TREE_TRANSLATE_Y = -120;
  }
  ...
  const { scrollYProgress } = useScroll({
    target: targetRef,
    // "start end" = top of About hits bottom of screen (starts fading)
    // "start center" = top of About hits center of screen (fully faded)
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
      ...
      >
        ...
        {/* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
        <div
          className="absolute top-0 right-0 w-[210vw] sm:w-[90vw] md:w-[70vw] lg:w-[60vw] max-w-[1200px] aspect-[552/500] origin-top-right select-none pointer-events-none"
          style={{
